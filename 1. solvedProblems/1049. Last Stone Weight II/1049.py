...
class Solution:
    def lastStoneWeightII(self, stones: List[int]) -> int:
        """
        转化成0-1背包问题套用模板即可
        只要不超过sum的一半, 则越多越好, 剩下的放在另一半
        https://leetcode-cn.com/problems/last-stone-weight-ii/solution/wen-ti-zhuan-hua-wei-0-1bei-bao-qiu-jie-by-wang-zh/
        """
        ...
        # printMatrix(dp)
        return abs((weightSum - dp[-1][-1]) - dp[-1][-1])
    # endFunc
# endClass
