...
class Solution:
    ...
    def sortList(self, head: ListNode) -> ListNode:
        ...
        rlt = newHead
        while head or mid:
            if not head or (mid and head.val > mid.val):
                newHead.next = mid
                mid = mid.next
            else:
                newHead.next = head
...
def func():
    ...
    input[0] = (
        ...
        singleLinkedList.buildSingleList([4, 2, 1, 3])
        # nTree.buildTree(None)
    )
    expectedRlt[0] = singleLinkedList.buildSingleList([1, 2, 3, 4])

    # ! para2
    input[1] = (
        singleLinkedList.buildSingleList([4, 2, 1, 3, 1])
    ...
    # ! para3
    input[2] = (
        singleLinkedList.buildSingleList([4, 2])
        # singleLinkedList.buildSingleList(None),
        # binaryTree.buildTree(None),
        # nTree.buildTree(None),
    )
