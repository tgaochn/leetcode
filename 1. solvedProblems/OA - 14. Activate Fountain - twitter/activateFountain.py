...
class Solution:
    def fountainActivation(self, a):
        """
        算是 greedy 里比较经典的区间覆盖问题，可以转化成 interval 以后 sort
        https://leetcode.com/discuss/interview-question/363036/Twitter-or-OA-2019-or-Activate-Fountain
        https://www.chegg.com/homework-help/questions-and-answers/hello-m-trouble-problem-would-prefer-solution-either-java-javascript-thank--another-test-c-q39698027
