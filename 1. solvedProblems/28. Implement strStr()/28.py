...
class Solution:
    def strStr(self, haystack: str, needle: str) -> int:
        ...
        nextLis 中的值是 needle 字符串的最长公共前缀后缀
        getNext 则返回这个list
        如 aabaaf -> [0, 1, 0, 1, 2, 0], 注意这个不能简单用前后指针计算
        """
    ...
    def strStr1(self, haystack: str, needle: str) -> int:
        ...
        for i in range(m):
            j = 0
            while i + j < m and j < n and haystack[i + j] == needle[j]:
                j += 1
            if j == n:
                return i
        return -1
