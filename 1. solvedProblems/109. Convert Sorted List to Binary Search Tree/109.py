...
class Solution:
    def sortedListToBST(self, head: ListNode) -> TreeNode:
        ...
        def conBST(node):
            ...
            root.left = conBST(node)
            root.right = conBST(slow.next)
            return root
    ...
    def sortedListToBST1(self, head: ListNode) -> TreeNode:
        ...
        def conBST(node, l, r):
            ...
            node.left = conBST(node.left, l, m - 1)
            node.right = conBST(node.right, m + 1, r)
            return node

        root = conBST(root, l, r)
        return root
    # endFunc
# endClass
...
def func():
    ...
    input1 = (
        ...
        # TODO
        singleLinkedList.buildSingleList([-10, -3, 0, 5, 9])
