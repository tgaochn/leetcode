...
class Solution:
    def carPooling(self, trips: List[List[int]], capacity: int) -> bool:
        ...
        formatedTrips = []
        for trip in trips:
            passengersNum = trip[0]
            start = trip[1]
            end = trip[2]
            formatedTrips.append((end, 0, passengersNum))
            formatedTrips.append((start, 1, passengersNum))
        
        formatedTrips.sort()
        totalCnt = 0
        for loc, curType, cnt in formatedTrips:
            if curType == 0:
                totalCnt -= cnt
            elif curType == 1:
                totalCnt += cnt
...
def func():
    ...
    # ! para2
    input[1] = parsePara('trips = [[2,1,5],[3,3,7]], capacity = 5')
    # input[1] = (
        # None,
    # )
    expectedRlt[1] = True
    ...
    # ! para3
    input[2] = parsePara('trips = [[2,1,5],[3,5,7]], capacity = 3')
    # input[2] = (
        # None,
    # )
    expectedRlt[2] = True
