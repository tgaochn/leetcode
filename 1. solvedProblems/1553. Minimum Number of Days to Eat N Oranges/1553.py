...
class Solution:
    ...
    def minDays(self, n: int) -> int:
        ...
        一般想法: 
        min(self.minDays(n - 1), self.minDays(n // 2) + n % 2, self.minDays(n // 3) + n % 3)
        ...
        """
        if n <= 1: return n
        # return 1 + min(self.minDays(n - 1), self.minDays(n // 2) + n % 2, self.minDays(n // 3) + n % 3)
