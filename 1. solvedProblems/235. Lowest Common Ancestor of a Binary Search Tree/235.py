...
class Solution:
    def lowestCommonAncestor(self, root: 'TreeNode', p: 'TreeNode', q: 'TreeNode') -> 'TreeNode':
        ...
        if (root.val > small and root.val < large) or root.val == large or root.val == small:
            return root
        elif root.val > large:
...
def func():
    ...
    # ! para1
    input1 = (
        binaryTree.buildTree([6, 2, 8, 0, 4, 7, 9, null, null, 3, 5]),
        
        binaryTree.buildTree([2]),
        binaryTree.buildTree([4]),
