...
class BSTIterator:
    ...
    https://leetcode-cn.com/problems/binary-search-tree-iterator/solution/mei-you-di-gui-jie-yong-zhan-ji-ke-wan-cheng-ologn/
    1. 中序扁平化, 空间复杂度 N
    2. 使用stack记录轨迹, 空间复杂度 logN
    """

    def __init__(self, root: TreeNode):
        self.stack = []
        self.inorderTraLeft(root)
    
    def inorderTraLeft(self, root: TreeNode):
        while root:
    ...
    def next(self) -> int:
        ...
        if topNode.right:
            self.inorderTraLeft(topNode.right)
        return topNode.val
