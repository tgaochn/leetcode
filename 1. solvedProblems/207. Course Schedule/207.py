...
class Solution:
    def canFinish(self, numCourses: int, prerequisites: List[List[int]]) -> bool:
        ...
        myQue = [cid for cid, inDegree in inDegreeHash.items() if inDegree == 0]
        myQue = deque(myQue)
        courseCnt = 0
...
def func():
    ...
    # ! para2
    input[1] = parsePara('numCourses = 2, prerequisites = [[1,0],[0,1]]')
    # input[1] = (
        # None,
    # )
    expectedRlt[1] = None
