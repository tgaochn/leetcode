...
class Solution:
    def isPalindrome(self, s: str) -> bool:
        ...
        while i < j:
            ...
            if (char1Ascii < ord('a') or char1Ascii > ord('z')) and (char1Ascii < ord('0') or char1Ascii > ord('9')):
                i += 1
                continue

            char2Ascii = ord(char2)
            if (char2Ascii < ord('a') or char2Ascii > ord('z')) and (char2Ascii < ord('0') or char2Ascii > ord('9')):
                j -= 1
                continue
